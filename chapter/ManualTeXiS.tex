...
\newcommand{\compilachapters}[1]{%
\includeonly{\ficherosBasicosTeXiS,\ficherosBasicosTexto,chapters/#1}%
}
...
\usepackage{float}
\usepackage{multirow}
\usepackage{amsmath,amssymb,amsthm,amsfonts,latexsym,cancel}
